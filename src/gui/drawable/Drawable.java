...
public abstract class Drawable {
	...
	public void update(Frame f, Rectangle r) {
		...
		case REL:// coordinate 0 is relative to the width of the container
			...
			break;
		case DIST://coordinate 0 defines the distance between the component's left edge and the container's right edge
		...
		case REL:// coordinate 1 is relative to the height of the container
			...
			break;
		case DIST://coordinate 1 defines the distance between the component's upper edge and the container's lower edge
		...
		case REL:// coordinate 2 is relative to the width of the container
			...
			break;
		case DIST://coordinate 2 defines the distance between the component's right edge and the container's right edge
		...
		case REL:// coordinate 3 is relative to the height of the container
			...
			break;
		case DIST://coordinate 3 defines the distance between the component's lower edge and the container's lower edge
		...
		if(s.equals("Debug")) {
			System.out.println(absoluteCoords.x + "," + absoluteCoords.y + "," + absoluteCoords.width + "," + absoluteCoords.height);
		}
	}
